...
/datum/asset/simple/directories/proc/get_assets_in_directories(list/directories = null)
	ASSERT(istype(directories))
	ASSERT(length(directories))

	var/list/tmp_assets = list()

	for (var/dir in directories)
		var/list/filenames = flist(dir)
		for(var/filename in filenames)
			if(copytext(filename, length(filename)) != "/") // Ignore directories.
				tmp_assets[filename] = dir + filename
...
/datum/asset/simple/directories/register()
	...
	assets = get_assets_in_directories(directories)
